    ...
    <div className="space-y-4 rounded-lg bg-white p-6 shadow-lg">
      ...
      <div className="grid gap-2">
        ...
        <p className=" text-gray-500 font-semibold ">
          <span className="text-black font-semibold font-lora">
            Customization
          </span>
          : {customization}
        </p>
      ...
      <div className="flex gap-4 justify-between">
        ...
        <button
          ...
          className="btn bg-[#8F3034] text-white font-semibold rounded-md border border-black px-6 dark:border-white dark:hover:text-slate-800 duration-300 hover:bg-[#8F3034]"
        >
          Delete
        </button>
      </div>
