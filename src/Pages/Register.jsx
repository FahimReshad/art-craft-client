...
const Register = () => {
    ...
    const handleRegistration = e => {
        ...
        if(password.length < 6){
           ...
           return toast.error('Password should have at least one upperCase character')
         }
         else if (!/[a-z]/.test(password)){
        ...
        <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%]">
            ...
            <div className="relative hidden h-full items-center justify-center bg-[#33232A] md:flex md:w-[60%] lg:w-[40%]">
                ...
                <div className="space-y-2 text-center">
                    <h2 className="text-3xl font-medium text-white/80 font-lora">Welcome</h2>
                    <p className="animate-pulse text-sm text-white/60 font-lora">Please Enter Your Information</p>
                </div>
            </div>
            {/* input side  */}
            <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
                <h2 className="pb-8 text-center text-3xl font-bold text-[#33232A]">Registration Here</h2>
                <form onSubmit={handleRegistration} className="flex  w-full flex-col items-center justify-center gap-4">
                    ...
                    <input className="w-[80%] rounded-lg border border-[#8EA7E9] px-6 py-2 focus:outline-none focus:ring-2 focus:ring-[#8EA7E9]/50 md:w-[60%]" type="text" placeholder="PhotoURL" name="photoURL"/>
                    ...
                    <p className="text-[14px] text-gray-400 font-lora">Do you have an account ? <Link to="/login" className="text-[#33232A] font-semibold ">Please Login</Link></p>
                    <input className="w-[80%] rounded-lg bg-[#33232A] px-6 py-2 font-medium text-white md:w-[60%]" type="submit" />
                </form>
